...
4. **Update Changelog**: ALWAYS document version changes in the `CHANGELOG.md` file manually or explicitly check it before releasing. Ensure that all notable modifications, features, and fixes are recorded for each version to keep users informed.
